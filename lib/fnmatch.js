...
var translate = exports.translate = function(pattern, options) {
    options || (options = {});
    var isNegated = options.negate !== false;
 ...
 */
exports.matches = function(path, pattern, opts) {
    var options = getOptions(opts);
    var {patterns, isNegated} = translate(pattern, options);
 ...
 */
exports.filter = function(paths, pattern, opts) {
    var options = getOptions(opts);
    var {patterns, isNegated} = translate(pattern, options);
