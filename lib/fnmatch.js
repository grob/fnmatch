 ...
 * fnmatch("test.js", "*.js");
 * fnmatch("test.js", "t{est,ango}.{js,json}");
 * fnmatch("module/src/test.js", "**");
 * fnmatch("01.json", "[0-9]{0..9}.json")
 */
 ...
 */
var getOptions = exports.getOptions = function(opts) {
 ...
 */
var cartesian = function cartesian(list, result, arr, idx) {
 ...
 * @param {String} The source pattern
...
var make = exports.make = function(pattern, options) {
    ...
    var patternSets = expandBraces(pattern.trim());
 ...
 */
var matchPattern = exports.matchPattern = function(segments, segmentIdx, patterns, patternIdx, options) {
 ...
 */
var getMatcher = exports.getMatcher = function(patterns, isNegated, options) {
    options || (options = {});
 ...
 * @param {String} patternStr The glob pattern to match against
 ...
 */
exports.fnmatch = function(path, patternStr, opts) {
 ...
 */
exports.filter = function(paths, patternStr, opts) {
    var options = getOptions(opts);
    var {patterns, isNegated} = translate(patternStr, options);
